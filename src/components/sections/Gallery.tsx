...
const ALL_ITEMS: GalleryItem[] = [
  { type: "photo", label: "Vision Coaching Institute students in classroom – Tulsipur 1",  src: "/images/gallery/photo-01.jpg"  },
  { type: "photo", label: "Vision Coaching Institute students in classroom – Tulsipur 2",  src: "/images/gallery/photo-02.jpg"  },
  { type: "photo", label: "CBSE coaching class at Vision Coaching Institute Tulsipur 3",   src: "/images/gallery/photo-03.jpg"  },
  { type: "photo", label: "CBSE coaching class at Vision Coaching Institute Tulsipur 4",   src: "/images/gallery/photo-04.jpg"  },
  { type: "photo", label: "Physics class at Vision Coaching Institute Tulsipur 5",         src: "/images/gallery/photo-05.jpg"  },
  { type: "photo", label: "Physics class at Vision Coaching Institute Tulsipur 6",         src: "/images/gallery/photo-06.jpg"  },
  { type: "photo", label: "Chemistry class at Vision Coaching Institute Tulsipur 7",       src: "/images/gallery/photo-07.jpg"  },
  { type: "photo", label: "Chemistry class at Vision Coaching Institute Tulsipur 8",       src: "/images/gallery/photo-08.jpg"  },
  { type: "photo", label: "Biology class at Vision Coaching Institute Tulsipur 9",         src: "/images/gallery/photo-09.jpg"  },
  { type: "photo", label: "Maths coaching batch at Vision Coaching Institute Tulsipur 10", src: "/images/gallery/photo-10.jpg"  },
  { type: "photo", label: "UP Board exam coaching at Vision Coaching Tulsipur 11",         src: "/images/gallery/photo-11.jpg"  },
  { type: "photo", label: "UP Board exam coaching at Vision Coaching Tulsipur 12",         src: "/images/gallery/photo-12.jpg"  },
  { type: "photo", label: "ICSE ISC students at Vision Coaching Institute Tulsipur 13",    src: "/images/gallery/photo-13.jpg"  },
  { type: "photo", label: "Best coaching institute Tulsipur Uttar Pradesh – Vision 14",    src: "/images/gallery/photo-14.jpg"  },
  { type: "photo", label: "Class 10 board exam preparation Vision Coaching Tulsipur 15",   src: "/images/gallery/photo-15.jpg"  },
  { type: "photo", label: "Class 12 board exam preparation Vision Coaching Tulsipur 16",   src: "/images/gallery/photo-16.jpg"  },
  { type: "photo", label: "Science coaching students Vision Coaching Institute Tulsipur 17", src: "/images/gallery/photo-17.jpg" },
  { type: "photo", label: "Science coaching students Vision Coaching Institute Tulsipur 18", src: "/images/gallery/photo-18.jpg" },
  { type: "photo", label: "Vision Coaching Institute Purani Bazar Tulsipur UP 19",          src: "/images/gallery/photo-19.jpg" },
  { type: "video", label: "Classroom teaching session – Vision Coaching Institute Tulsipur 1", src: "/images/gallery/video-01.mp4" },
  { type: "video", label: "Classroom teaching session – Vision Coaching Institute Tulsipur 2", src: "/images/gallery/video-02.mp4" },
  { type: "video", label: "Classroom teaching session – Vision Coaching Institute Tulsipur 3", src: "/images/gallery/video-03.mp4" },
  { type: "video", label: "Classroom teaching session – Vision Coaching Institute Tulsipur 4", src: "/images/gallery/video-04.mp4" },
  { type: "video", label: "Classroom teaching session – Vision Coaching Institute Tulsipur 5", src: "/images/gallery/video-05.mp4" },
  { type: "video", label: "Classroom teaching session – Vision Coaching Institute Tulsipur 6", src: "/images/gallery/video-06.mp4" },
];
